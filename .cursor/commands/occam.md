...
Apply Occam's Razor principle to simplify code: remove unnecessary complexity, eliminate redundant code, and refactor for clarity while maintaining functionality.

## Usage

When you use `/occam`, I will:
...
- **Remove unused code**: Delete dead code, unused imports, and unused variables
...
- Simplify nested conditionals into early returns
